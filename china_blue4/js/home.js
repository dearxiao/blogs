 							...
 							$(".field_yuan").rotate({
 								bind: {
 									click: function () {
 										$(".field_li").fadeOut();
 										$(".one_txt").fadeIn();
 										$(".field_yuan img").stop().animate({
 											width: "55px",
 											height: "55px"
 										})
 										$(".field_box").stop().animate({
 											width: "90px",
 											height: "90px",
