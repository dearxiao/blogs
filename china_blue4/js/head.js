$(function () {
    ...
    $('.xl').click(function () {
        if (xl) {
            $(this).css({
                background: 'url(images/top2.png) no-repeat 85%',
                backgroundSize: '18%'
            })
            $(this).parent('a').next('.small_ul').slideUp()
            xl = false;
        } else {
            $(this).css({
                background: 'url(images/down2.png) no-repeat 85%',
                backgroundSize: '18%'
            })
            $(this).parent('a').next('.small_ul').slideDown()
            xl = true;
        }
        return false
    })
